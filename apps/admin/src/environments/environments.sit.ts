...
const servicePathPrefix = 'sit-';

export const environment = {
  consent: {
    organizationId: '', // TODO: SIT consent organization ID
    collectionPointId: '', // TODO: SIT consent collection point ID
  },
  srm: {
  ...
  cdnPaths: {
    imageUserProfile: '', // TODO: SIT CDN URL สำหรับรูปโปรไฟล์ผู้ใช้
  },
};
