...
export const environment = {
  consent: {
    organizationId: '', // TODO: PROD consent organization ID
    collectionPointId: '', // TODO: PROD consent collection point ID
  },
  srm: {
  ...
  servicePaths: {
    baseDomain: 'https://gateway.exim.go.th',
  ...
  cdnPaths: {
    imageUserProfile: '', // TODO: PROD CDN URL สำหรับรูปโปรไฟล์ผู้ใช้
  },
};
