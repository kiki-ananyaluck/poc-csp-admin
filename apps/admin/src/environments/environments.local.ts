...
export const environment = {
  consent: {
    organizationId: '', // TODO: Local consent organization ID
    collectionPointId: '', // TODO: Local consent collection point ID
  },
  srm: {
  ...
  servicePaths: {
    baseDomain: 'https://gateway-sit.exim.go.th',
  ...
  cdnPaths: {
    imageUserProfile: 'https://suastoragedev.exim.go.th/', // TODO: Local CDN URL สำหรับรูปโปรไฟล์ผู้ใช้
  },
};
